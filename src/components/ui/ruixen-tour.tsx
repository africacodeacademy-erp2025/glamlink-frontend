    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <div className="flex h-full w-full flex-col md:flex-row">
          <div className="w-full border-gray-200 p-6 dark:border-neutral-800 md:w-1/3 md:border-r">
            <div className="flex flex-col gap-3">
              <Image
                ...
                width={48}
                height={48}
                className="h-12 w-12 rounded-full border-4 border-gray-200 bg-white object-contain p-1 dark:border-neutral-800"
                priority
              />
                ...
                {steps.map((s, index) => (
                  ...
                  >
                    {index < step ? (
                      ...
                      <div className="h-2.5 w-2.5 rounded-full bg-black dark:bg-white/40" />
                    )}
          ...
          <div className="flex w-full flex-col justify-between p-8 md:w-2/3">
            <div className="space-y-4">
                ...
                <div className="min-h-[60px]">
                  <AnimatePresence mode="wait">
                    <motion.p
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      transition={{ duration: 0.25 }}
                      className="text-base text-gray-600 opacity-90 dark:text-gray-400"
                    >
              ...
              <div className="flex h-60 w-full items-center justify-center rounded-lg bg-gray-100 dark:bg-neutral-900">
                <div className="relative h-full w-full overflow-hidden rounded-lg border-4 border-gray-200 dark:border-neutral-800">
                  <AnimatePresence mode="wait">
                    <motion.div
